...
const NavbarSpacer = ({ className, ref, ...props }: React.ComponentProps<"div">) => {
    return <div ref={ref} className={cn("-ml-4 flex-1", className)} {...props} />;
};

const NavbarStart = ({ className, ref, ...props }: React.ComponentProps<"div">) => {
    return <div ref={ref} className={cn("p-2 py-4 md:p-2", className)} {...props} />;
};
...
const NavbarTrigger = ({ className, onPress, ref, ...props }: NavbarTriggerProps) => {
    ...
    return (
        <Button
            ...
            size="sq-sm"
            className={cn("-ml-2 min-lg:hidden", className)}
            onPress={(event) => {
                onPress?.(event);
                toggleNavbar();
            }}
...
const NavbarLabel = ({ className, ...props }: React.ComponentProps<"span">) => {
    return (
        <span
            ...
            className={cn("col-start-2 row-start-1 truncate", className)}
            {...props}
        />
    );
};
